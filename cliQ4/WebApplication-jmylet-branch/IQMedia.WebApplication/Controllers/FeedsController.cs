    ...
    public class FeedsController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                FeedsSearchResponse fsr = SearchMediaResults(medium, fromDT, toDT, searchrequest, null, null, dma, station, competeurl, iqdmaid, handle, publication, author, null, false, false, isAudienceSort, null, 1, true, defaultToUnread, isHeard, isSeen, isPaid, isEarned, usePESHFilters);
        ...
        public ContentResult GetFilterData(DateTime? fromDate, DateTime? toDate, List<string> searchRequestID, List<string> mediumTypes, string keyword, short? sentiment, string Dma, string Station, string CompeteUrl,
                                                int? _IQDMAID, string Handle, string publication, string author, short? prominenceValue, bool isProminenceAudience, bool? isRead, bool? isHeardFilter, bool? isSeenFilter, 
                                                bool? isPaidFilter, bool? isEarnedFilter, bool? usePESHFilters)
        {
            try
            {
        ...
        public ContentResult _MediaJsonResults(DateTime? fromDate, DateTime? toDate, List<string> searchRequestID, List<string> mediumTypes, string keyword, short? sentiment, bool isAsc, int? pageSize, string Dma, string Station, string CompeteUrl,
                                                int? _IQDMAID, string Handle, string publication, string author, bool? isRead, short? prominenceValue, bool isProminenceAudience, bool? isAudienceSort, int numPages, bool isHeardFilter, bool? isSeenFilter, bool? isPaidFilter, bool? isEarnedFilter, bool? usePESHFilters)
        {
            try
            {
                ...
                FeedsSearchResponse fsr = SearchMediaResults(mediumTypes, fromDate, toDate, searchRequestID, keyword, sentiment, Dma, Station, CompeteUrl, _IQDMAID, Handle, publication, author, prominenceValue, isProminenceAudience, isAsc, isAudienceSort, pageSize, numPages, true, isRead, isHeardFilter, isSeenFilter, isPaidFilter, isEarnedFilter, usePESHFilters);
        ...
        public ContentResult _MoreMediaJsonResults(DateTime? fromDate, DateTime? toDate, List<string> searchRequestID, List<string> mediumTypes, string keyword, short? sentiment, bool isAsc, int? pageSize, string Dma, string Station, string CompeteUrl, int? _IQDMAID, string Handle,
                                                    string publication, string author, bool? isRead, short? prominenceValue, bool isProminenceAudience, bool? isAudienceSort, bool? isHeardFilter, bool? isSeenFilter, bool? isPaidFilter, bool? isEarnedFilter, bool? usePESHFilters)
        {
            try
            {
                keyword = !string.IsNullOrWhiteSpace(keyword) ? keyword : null;

                FeedsSearchResponse fsr = SearchMediaResults(mediumTypes, fromDate, toDate, searchRequestID, keyword, sentiment, Dma, Station, CompeteUrl, _IQDMAID, Handle, publication, author, prominenceValue, isProminenceAudience, isAsc, isAudienceSort, pageSize, 1, false, isRead, isHeardFilter, isSeenFilter, isPaidFilter, isEarnedFilter, usePESHFilters);
        ...
        public JsonResult ExportCSV(List<string> p_RecordList, bool p_SelectAll, bool p_SelectAllParent, DateTime? fromDate, DateTime? toDate, List<string> searchRequestID, List<string> mediumTypes, string keyword, short? sentiment, bool isAsc, string Dma, string Station, string CompeteUrl, int? _IQDMAID, string Handle,
                                        string publication, string author, bool? isRead, bool? isHeardFilter, bool? isSeenFilter, bool? isPaidFilter, bool? isEarnedFilter, bool? usePESHFilters, short? prominenceValue, bool isProminenceAudience, bool? isAudienceSort)
        {
            try
            {
                ...
                if (!p_SelectAll && !p_SelectAllParent)
                {
                    ...
                    fsr = SearchMediaResultsByID(lstMediaID, null, null, null, null, null, null, null, null, null, null, null, null, null, null, false, false, null, lstMediaID.Count, false, null, null, null, null, null, null);
                }
                else
                {
                    fsr = SearchMediaResultsByID(null, mediumTypes, fromDate, toDate, searchRequestID, keyword, sentiment, Dma, Station, CompeteUrl, _IQDMAID, Handle, publication, author, prominenceValue, isProminenceAudience, isAsc, isAudienceSort, feedsTempData.MaxFeedsExportCSVLimit.Value, p_SelectAllParent, isRead, 
                                                    isHeardFilter, isSeenFilter, isPaidFilter, isEarnedFilter, usePESHFilters);
                }
        ...
        public JsonResult GetProQuestResultByID(string mediaID)
        {
            try
            {
                FeedsSearchResponse fsr = SearchMediaResultsByID(new List<string>() { mediaID }, null, null, null, null, null, null, null, null, null, null, null, null, null, null, false, false, null, 1, false, null, null, null, null, null, null);
        ...
        private string GetCSVData(List<IQAgent_MediaResultsModel> lstIQAgent_MediaResultsModel)
        {
            ...
            if (lstIQAgent_MediaResultsModel != null)
            {
                ...
                sb.Append("Media Date time,Agent,Time Zone,Source,Title,Outlet,DMA,URL" + (sessionInformation.IsNielsenData || sessionInformation.IsCompeteData ? ",Audience,Audience Source,Media Value ($)" : string.Empty) + (sessionInformation.IsNielsenData ? ",National Audience,National Media Value ($)" : string.Empty) + ",Twitter Followers,Twitter Following,Twitter Klout Score," + (hasFacebook ? "Likes,Comments,Shares," : string.Empty) + "Text");
        ...
        public FeedsSearchResponse SearchMediaResults(List<string> mediaTypes, DateTime? fromDate, DateTime? toDate, List<string> searchRequestID, string keyword, short? sentiment, string dma, string station, string competeUrl, int? iQDmaID, string handle,
                                                        string publication, string author, short? prominenceValue, bool isProminenceAudience, bool isAsc, bool? isAudienceSort, int? pageSize, int numPages, bool isFacetingEnabled, bool? isRead, bool? isHeardFilter, bool? isSeenFilter, bool? isPaidFilter, bool? isEarnedFilter, bool? usePESHFilters)
        {
            try
            {
                sessionInformation = ActiveUserMgr.GetActiveUser();
        ...
        public FeedsSearchResponse SearchMediaResultsByID(List<string> mediaIDs, List<string> mediaTypes, DateTime? fromDate, DateTime? toDate, List<string> searchRequestID, string keyword, short? sentiment, string dma, string station, string competeUrl, int? iQDmaID,
                                                            string handle, string publication, string author, short? prominenceValue, bool isProminenceAudience, bool isAsc, bool? isAudienceSort, int pageSize, bool isOnlyParents, bool? isRead, bool? isHeardFilter, bool? isSeenFilter, bool? isPaidFilter, bool? isEarnedFilter, bool? usePESHFilters)
        {
            try
            {
        ...
        public FeedsSearchResponse SearchMediaResults_Task(List<string> mediaIDs, List<string> mediaTypes, DateTime? fromDate, DateTime? fromDateLocal, DateTime? toDate, DateTime? toDateLocal, List<string> searchRequestID,
                                                            ...
                                                            bool isProminenceAudience, bool isAsc, bool? isAudienceSort, int pageSize, long? fromRecordID, bool isFacetingEnabled, bool isOnlyParents, bool? isRead, bool? isHeardFilter, bool? isSeenFilter, bool? isPaidFilter, bool? isEarnedFilter, bool? usePESHFilters, string currentUrl, 
        ...
        public FeedsSearchResponse GetFilterData_Task(List<string> mediaTypes, DateTime? fromDate, DateTime? fromDateLocal, DateTime? toDate, DateTime? toDateLocal, List<string> searchRequestID,
                                                            string keyword, short? sentiment, string dma, string station, string competeUrl, int? iQDmaID, string handle, string publication, string author, short? prominenceValue,
                                                            bool isProminenceAudience, bool? isRead, bool? isHeardFilter, bool? isSeenFilter, bool? isPaidFilter, bool? isEarnedFilter, bool? usePESHFilters, 
                                                            CancellationToken token, FeedsSearchResponse fsr)
        {
            try
            {
