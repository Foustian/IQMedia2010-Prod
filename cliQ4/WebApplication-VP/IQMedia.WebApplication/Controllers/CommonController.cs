    ...
    public class CommonController : Controller
    {
        ...
        public static Dictionary<string, object> GetDashboardOverviewResults(List<SummaryReportModel> listOfSummaryReportData, DateTime p_FromDate, DateTime p_ToDate, Int16 p_SearchType, Dictionary<long, string> p_SearchRequests, IQAgent_DashBoardPrevSummaryModel p_PrevIQAgentSummary, List<ThirdPartyDataTypeModel> p_ThirdPartyDataTypes)
        {
            try
            {
                ...
                SummaryReportMulti linechart = LineChart(listOfSummaryReportData, p_FromDate, p_ToDate, p_SearchType, p_SearchRequests, p_PrevIQAgentSummary != null ? p_PrevIQAgentSummary.ListOfIQAgentPrevSummary : null, p_ThirdPartyDataTypes);
        ...
        public static SummaryReportMulti LineChart(List<SummaryReportModel> listOfSummaryReportData, DateTime p_FromDate, DateTime p_ToDate, Int16 p_SearchType, Dictionary<long, string> p_SearchRequests, List<IQAgent_ComparisionValues> p_ListOfIQAgent_ComparisionValues, List<ThirdPartyDataTypeModel> p_ThirdPartyDataTypes)
        {
            ...
            if (p_SearchType == 0)
            {
                 lstSummaryReportMulti = dashboardLogic.HighChartsLineChartHour(listOfSummaryReportData, p_FromDate, p_ToDate, null, sessionInformation.Isv4TM, sessionInformation.gmt, sessionInformation.dst, p_SearchRequests, p_ListOfIQAgent_ComparisionValues, p_ThirdPartyDataTypes, sessionInformation.Isv4NM, sessionInformation.Isv4SM, sessionInformation.Isv4TW, sessionInformation.Isv4TV, sessionInformation.Isv4BLPM, false, sessionInformation.Isv4PQ, sessionInformation.IsNielsenData, sessionInformation.IsCompeteData, sessionInformation.IsThirdPartyData);
            }
            else if (p_SearchType == 1)
            {
                lstSummaryReportMulti = dashboardLogic.HighChartsLineChart(listOfSummaryReportData, p_FromDate, p_ToDate, null, sessionInformation.Isv4TM, p_SearchRequests, p_ListOfIQAgent_ComparisionValues, p_ThirdPartyDataTypes, sessionInformation.Isv4NM, sessionInformation.Isv4SM, sessionInformation.Isv4TW, sessionInformation.Isv4TV, sessionInformation.Isv4BLPM, false, sessionInformation.Isv4PQ, sessionInformation.IsNielsenData, sessionInformation.IsCompeteData, sessionInformation.IsThirdPartyData);
            }
            else if (p_SearchType == 3)
            {
                lstSummaryReportMulti = dashboardLogic.HighChartsLineChartMonth(listOfSummaryReportData, p_FromDate, p_ToDate, sessionInformation.Isv4TM, p_SearchRequests, p_ListOfIQAgent_ComparisionValues, p_ThirdPartyDataTypes, sessionInformation.Isv4NM, sessionInformation.Isv4SM, sessionInformation.Isv4TW, sessionInformation.Isv4TV, sessionInformation.Isv4BLPM, false, sessionInformation.Isv4PQ, sessionInformation.IsNielsenData, sessionInformation.IsCompeteData, sessionInformation.IsThirdPartyData);
            }
