...
//        }
    ...
    if (_tab === "Sources")
    {
        $("#iFrameFeeds").attr("src",
            "//" + window.location.hostname + "/Feeds?" + dateStr + "&isShowMTChart=true&searchrequest=[" + agents + "]&searchrequestDesc=" +
...
//        }
        ...
        $("#iFrameFeeds").attr("src",
            "//" + window.location.hostname + "/Feeds?" + dateStr + '&isShowMTChart=true&searchrequest=["' + reqID + '"]&searchrequestDesc=' + 
...
function RenderHighChartsPieChart(jsonChartData) {
    ...
    _DEVJSONStr = jsonChartData;
    _DEVJsonChart = jsonPieChart;
