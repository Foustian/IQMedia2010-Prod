...
// Called when a video clip is created to mark the TV record as read
$(function () {
...
$(document).ready(function () {
    ...
    var qryInProgram = getParameterByName("inprogram");
    _InProgram = false;
    if (qryInProgram !== '')
    {
        _InProgram = $.parseJSON(qryInProgram);
    }
...
function GetFilterData() {
    var jsonPostData = {
        ...
        isInProgramFilter: _InProgram,
        usePESHFilters: _Seen || _Heard || _Paid || _Earned || _InProgram,
...
function CallHandler(numPages, resultMsg) {
    ...
    if (DateValidation()) {
        ...
        var jsonPostData = {
            ...
            isEarnedFilter: _Earned,
            isInProgramFilter: _InProgram,
            usePESHFilters: _Heard || _Seen || _Paid || _Earned || _InProgram,
            showTitle: _showTitle,
            dayOfWeek: _dayOfWeek,
            timeOfDay: _timeOfDay,
            useGMT: _useGMT,
...
function SetActiveFilter() {
    ...
    if (_InProgram == true)
    {
        $("#divActiveFilter").append('<div id="divMediumActiveFilter" class="filter-in">In Program<span class="cancel" onclick="RemoveFilter(25);"></span></div>');
        isFilterActive = true;
    }
