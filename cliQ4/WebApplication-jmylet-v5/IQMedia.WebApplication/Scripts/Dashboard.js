...
var _subGroup = null;
var _prevPostData = null;

function CohortDateChange() {
    // Called if changing date range for reports - need to call specific methods with previous post data
    var newPostData = _prevPostData;
    newPostData.startDate = _FromDate;
    newPostData.endDate = _ToDate;
    GetReport(newPostData);
}
