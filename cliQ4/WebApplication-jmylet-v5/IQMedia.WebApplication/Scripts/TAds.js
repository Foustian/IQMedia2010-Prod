...
var closeOnClickOff = function () {
    ...
    var allChildren = narrowResultsUl.add(narrowResultsDiv.add(logoFilterDiv.add(adFilterUl)));
...
function SetIndustry(id, eleName, status) {
    ...
    if(status =="deselect"){
        _RequestIndustry.splice(_RequestIndustry.indexOf(id), 1);
    ...
    if (result.isSuccess) {
        ...
        //dma/market
           ...
           $("#ulNetwork").hide();
            ...
            //logos
            if (_RequestLogoSearch == null || _RequestLogoSearch.length == 0) {_RequestLogoBrand = []; }
            var iqlogolist = "";  
