    ...
    public class FeedsController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(HttpContext.Request.QueryString["inprogram"]))
                {
                    isInProgram = Convert.ToBoolean(HttpContext.Request.QueryString["inprogram"].ToString());
                    usePESHFilters = true;
                }
                ...
                FeedsSearchResponse fsr = SearchMediaResults(subMediaTypes, fromDT, toDT, searchrequest, null, null, dma, station, competeurl, iqdmaids, handle, publication, author, null, false, false, isAudienceSort, null, 1, true, defaultToUnread, isHeard, isSeen, isPaid, isEarned, isInProgram, usePESHFilters, showTitle, dayOfWeek, timeOfDay, useGMT, isHour, isMonth, stationAffil, demographic);
        ...
        public ContentResult GetFilterData(DateTime? fromDate, DateTime? toDate, List<string> searchRequestID, List<string> mediumTypes, string keyword, short? sentiment, string Dma, string Station, string CompeteUrl,
                                                ...
                                                bool? isPaidFilter, bool? isEarnedFilter, bool? isInProgramFilter, bool? usePESHFilters, string showTitle, List<int> dayOfWeek, List<int> timeOfDay, bool? useGMT, string stationAffil, string demographic)
       {
            try
            {
        ...
        public JsonResult ExportCSV(List<string> p_RecordList, bool p_SelectAll, bool p_SelectAllParent, DateTime? fromDate, DateTime? toDate, List<string> searchRequestID, List<string> mediumTypes, string keyword, short? sentiment, bool isAsc, string Dma, string Station, string CompeteUrl, List<string> _DmaIDs, string Handle,
                                        string publication, string author, bool? isRead, bool? isHeardFilter, bool? isSeenFilter, bool? isPaidFilter, bool? isEarnedFilter, bool? isInProgramFilter, short? prominenceValue, bool isProminenceAudience, bool? isAudienceSort, string showTitle, List<int> dayOfWeek, List<int> timeOfDay, bool isHour, bool isMonth,
                                        string title, bool getTVUrl, bool? useGMT)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (isInProgramFilter.HasValue)
                    {
                        xDoc.Root.Add(new XElement("IsInProgram", isInProgramFilter));
                    }
        ...
        public FeedsSearchResponse GetFilterData_Task(List<string> mediaTypes, DateTime? fromDate, DateTime? fromDateLocal, DateTime? toDate, DateTime? toDateLocal, List<string> searchRequestID,
                                                              string keyword, short? sentiment, string dma, string station, string competeUrl, List<string> iQDmaIDs, string handle, string publication, string author, short? prominenceValue,
                                                            bool isProminenceAudience, bool? isRead, bool? isHeardFilter, bool? isSeenFilter, bool? isPaidFilter, bool? isEarnedFilter, bool? isInProgramFilter, bool? usePESHFilters, string showTitle, List<int> dayOfWeek, List<int> timeOfDay, bool? useGMT, string stationAffil, string demographic,
                                                          CancellationToken token, FeedsSearchResponse fsr)
        {
            try
            {
