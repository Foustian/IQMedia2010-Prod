...
namespace IQMedia.Data
{
    public class IQArchieveDA : IDataAccess
    {
        ...
        public Dictionary<string, object> GetIQArchieveResults(string ClientGUID, string CustomerGUID, long FromRecordID, int PageSize, DateTime? FromDate, DateTime? ToDate, string SubMediaType, string SearchTerm,
                                                                string CategoryGUID, string SelectionType, bool IsAsc, string SortColumn, bool IsEnableFilter, string currentUrl, ref long SinceID, out long TotalResults, out long TotalResultsDisplay, bool IsRadioAccess, bool IsLibraryRollup)
        {
            try
            {
        ...
        public IQArchive_DisplayLibraryReport GetIQArchieveResultsForLibraryReport(long ReportID, string currentUrl, Guid ClientGuid, bool IsRadioAccess, bool isNielsenData, bool isCompeteData, List<IQ_MediaTypeModel> lstSubMediaTypes, out int totalDisplayedRecords)
        {
            try
            {
                ...
                {
                    reports = FillLibraryIQ_Report(dataset.Tables[8]);
                }
                ...
                if (dictResults.Count > 0 && dictResults["Result"] != null)
                {
                    ...
                    {
                        case "SubMediaType":
                            group1Elements = archiveResults.Select(s => new Tuple<string, string>(s.SubMediaType.ToString(), s.SubMediaTypeDesc)).Distinct().ToList();
                            break;
                        case "CategoryName":
                    ...
                    foreach (Tuple<string, string> element in group1Elements)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                case "SubMediaType":
                                    group2Elements = group1ResultsBase.Select(s => new Tuple<string, string>(s.SubMediaType.ToString(), s.SubMediaTypeDesc)).Distinct().ToList();
                                    break;
                                case "CategoryName":
                            ...
                            foreach (Tuple<string, string> element2 in group2Elements)
                            {
                                ...
                                totalDisplayedRecords += groupTier2Model.ArchiveResults.Count;
                                groupTier1Model.GroupTier2Counts.Add(element2Value, groupTier2Model.ArchiveResults.Count);
                                groupTier1Model.GroupTier2Results.Add(groupTier2Model);
                            }
                        }
        ...
        private Dictionary<string, object> FillIQArchieveResults(DataSet dataSet, string currentUrl, bool IsEnableFilter, string SortColumn = "", bool IsAsc = false, bool IsReport = false)
        {
            ...
            if (dataSet != null && dataSet.Tables.Count > 0)
            {
                ...
                if (!IsReport && dataSet.Tables.Count > 8 && dataSet.Tables[8] != null)
                {
                    foreach (DataRow drChild in dataSet.Tables[8].Rows)
                    {
                        ...
                        if (dataSet.Tables[8].Columns.Contains("_ParentID") && !drChild["_ParentID"].Equals(DBNull.Value))
                        {
                        ...
                        if (dataSet.Tables[8].Columns.Contains("Market") && !drChild["Market"].Equals(DBNull.Value))
                        {
                            objIQArchive_ArchiveClipModel.Market = Convert.ToString(drChild["Market"]);
                        }

                        if (dataSet.Tables[8].Columns.Contains("Station_Call_Sign") && !drChild["Station_Call_Sign"].Equals(DBNull.Value))
                        {
                            objIQArchive_ArchiveClipModel.Station_Call_Sign = Convert.ToString(drChild["Station_Call_Sign"]);
                        }

                        if (dataSet.Tables[8].Columns.Contains("PositiveSentiment") && !drChild["PositiveSentiment"].Equals(DBNull.Value))
                        {
                            objIQArchive_ArchiveClipModel.PositiveSentiment = Convert.ToInt16(drChild["PositiveSentiment"]);
                        }

                        if (dataSet.Tables[8].Columns.Contains("ClipDate") && !drChild["ClipDate"].Equals(DBNull.Value))
                        {
                            objIQArchive_ArchiveClipModel.LocalDateTime = Convert.ToDateTime(drChild["ClipDate"]);
                        }

                        if (dataSet.Tables[8].Columns.Contains("NegativeSentiment") && !drChild["NegativeSentiment"].Equals(DBNull.Value))
                        {
                            objIQArchive_ArchiveClipModel.NegativeSentiment = Convert.ToInt16(drChild["NegativeSentiment"]);
                        }

                        if (dataSet.Tables[8].Columns.Contains("StationLogo") && !drChild["StationLogo"].Equals(DBNull.Value))
                        {
                        ...
                        if (dataSet.Tables[8].Columns.Contains("TimeZone") && !drChild["TimeZone"].Equals(DBNull.Value))
                        {
                            objIQArchive_ArchiveClipModel.TimeZone = Convert.ToString(drChild["TimeZone"]);
                        }

                        if (dataSet.Tables[8].Columns.Contains("Dma_Num") && !drChild["Dma_Num"].Equals(DBNull.Value))
                        {
                            objIQArchive_ArchiveClipModel.Dma_Num = Convert.ToString(drChild["Dma_Num"]);
                        }

                        if (dataSet.Tables[8].Columns.Contains("CategoryGUID") && !drChild["CategoryGUID"].Equals(DBNull.Value))
                        {
                        ...
                        if (dataSet.Tables[8].Columns.Contains("CategoryName") && !drChild["CategoryName"].Equals(DBNull.Value))
                        {
                            objIQArchiveChild_MediaModel.CategoryName = Convert.ToString(drChild["CategoryName"]);
                        }

                        if (dataSet.Tables[8].Columns.Contains("CreatedDate") && !drChild["CreatedDate"].Equals(DBNull.Value))
                        {
                ...
                if (!IsReport && dataSet.Tables.Count > 9 && dataSet.Tables[9] != null)
                {
                    foreach (DataRow dr in dataSet.Tables[9].Rows)
                    {
                        ...
                        if (dataSet.Tables[9].Columns.Contains("_ParentID") && !dr["_ParentID"].Equals(DBNull.Value))
                        {
                        ...
                        if (dataSet.Tables[9].Columns.Contains("Publication") && !dr["Publication"].Equals(DBNull.Value))
                        {
                            Uri aPublisherUri;
                        ...
                        if (dataSet.Tables[9].Columns.Contains("CategoryGUID") && !dr["CategoryGUID"].Equals(DBNull.Value))
                        {
                            if (!string.IsNullOrWhiteSpace(Convert.ToString(dr["CategoryGUID"])))
                            {
                                objIQArchive_MediaModel.CategoryGUID = new Guid(Convert.ToString(dr["CategoryGUID"]));
                        ...
                        if (dataSet.Tables[9].Columns.Contains("CategoryName") && !dr["CategoryName"].Equals(DBNull.Value))
                        {
                            objIQArchive_MediaModel.CategoryName = Convert.ToString(dr["CategoryName"]);
                        }

                        if (dataSet.Tables[9].Columns.Contains("CreatedDate") && !dr["CreatedDate"].Equals(DBNull.Value))
                        {
                            objIQArchive_MediaModel.CreatedDate = Convert.ToDateTime(dr["CreatedDate"]);
                        }

                        if (dataSet.Tables[9].Columns.Contains("IQLicense") && !dr["IQLicense"].Equals(DBNull.Value))
                        {
                ...
                if (IsEnableFilter)
                {
                    /* dataSet.Tables[10] represents MediaDates table
                     * dataSet.Tables[11] represents SubMediaType table
                     * dataSet.Tables[12] represents Customer table 
                     * dataSet.Tables[13] represents CustomCategory table */
                    filter = FillFilterFromDataSet(dataSet.Tables[10], dataSet.Tables[11], dataSet.Tables[12], dataSet.Tables[13]);
                }
        ...
        public List<IQArchive_Filter> GetCategoryFilter(string ClientGUID, string CustomerGUID, DateTime? FromDate, DateTime? ToDate, string SubMediaType, string SearchTerm, string CategoryGUID, long SinceID, bool IsRadioAccess)
        {
        ...
        public List<IQArchive_Filter> GetMCMediaCategoryFilter(string ClientGUID, string CustomerGUID, DateTime? FromDate, DateTime? ToDate, string SubMediaType, string SearchTerm, string CategoryGUID, long SinceID, bool IsRadioAccess, int? MasterClientID, string reportGUID)
        {
            try
            {
        ...
        public Dictionary<string, object> GetMCMediaResults(string ClientGUID, string CustomerGUID, long FromRecordID, int PageSize, DateTime? FromDate, DateTime? ToDate, string SubMediaType, string SearchTerm,
                                                                string CategoryGUID, string SelectionType, bool IsAsc, string SortColumn, bool IsEnableFilter, string currentUrl, ref long SinceID, out long TotalResults, bool IsRadioAccess, int? MasterClientID)
        {
            try
            {
                CustomerGUID = !string.IsNullOrWhiteSpace(CustomerGUID) ? CustomerGUID : null;
