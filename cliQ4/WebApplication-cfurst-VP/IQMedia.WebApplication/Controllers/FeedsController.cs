                                        ...
                                        string publication, string author, bool? isRead, bool? isHeardFilter, bool? isSeenFilter, bool? isPaidFilter, bool? isEarnedFilter, bool? usePESHFilters, short? prominenceValue, bool isProminenceAudience, bool? isAudienceSort)
        {
            try
            {
                ...
                if (!p_SelectAll && !p_SelectAllParent)
                {
                    ...
                    result = iQService_FeedsLogic.InsertFeedsExport(sessionInformation.CustomerGUID, false, sortType, null, lstMediaID);
                }
                else
                {
                    if (fromDate.HasValue && toDate.HasValue)
                    ...
                    if (_IQDMAID.HasValue) { xDoc.Root.Add(new XElement("DmaID", _IQDMAID)); }
                    ...
                    xDoc.Root.Add(new XElement("IsOnlyParents", p_SelectAllParent));
                    ...
                    result = iQService_FeedsLogic.InsertFeedsExport(sessionInformation.CustomerGUID, true, sortType, xDoc.ToString(), null);
                }
