...
function SetMediumFilter(result) {
    ...
    $.each(result.discoveryMediumFilter, function (eventID, eventData) {
        ...
        discoveryMedium += '<li onclick="SetMediaType(\'' + eventData.MediaType + '\');"' + mediaTypeClass + '><a data-toggle="dropdown" class="dropdown-toggle" href="#" role="button" name="aMediaType">' + eventData.MediaTypeName + '</a>';
