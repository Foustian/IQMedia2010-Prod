...
$(document).ready(function () {
    ...
    if (qryMedium != '') {
        _SubMediaTypes = $.parseJSON(qryMedium);
    }
...
function ModifyFilters(filter) {
    ...
    if (filter.ListOfMediaTypeFilter != null) {
        $.each(filter.ListOfMediaTypeFilter, function (eventID, eventData) {
            ...
            mediumLI += '<li onclick="SetMediaType(\'' + eventData.Value + '\');"' + mediaTypeClass + '><a data-toggle="dropdown" class="dropdown-toggle" href="#" role="button" name="aMediaType">';
