...
function GetNetworkShowSpecificTable() {
    ...
    $.ajax({
        ...
        error: function (result) {
            console.log("GetNetworkShowSpecificTable ajax error");
        }
    });
}
...
function ToggleOverlayData(overlayType) {
    ...
    if (_ActiveOverlayType !== overlayType)
    {
        ...
        $.ajax({
            ...
            error: function (result) {
                console.log("ToggleOverlayData ajax error");
            }
        });
    }
    else
...
function ChangeTab(SecondaryTabID) {
    ...
    if (_tab == "OverTime")
    {
        ...
        else if (_prevTab != "Networks" && _prevTab != "Shows" && _prevTab != "Daypart" && _tab != "Daypart") {
            GetTabSpecificTable();
        }
        else {
...
function FormatSplineTooltip() {
    var campaignHeader = "Campaign Day: " + this.point.x + "<br/>CalendarDay: " + this.point.Date + "<br/>";
...
function SpecifyDateRange() {
    ...
    var startDate = new Date(_dateFrom);
    var endDate = new Date(_dateTo);

    var startDateTxt = (startDate.getMonth() + 1) + "/" + (startDate.getDate() + 1) + "/" + startDate.getFullYear();
    var endDateTxt = (endDate.getMonth() + 1) + "/" + (endDate.getDate() + 1) + "/" + endDate.getFullYear();
...
function FormatComparisonTooltip() {
    var header = "Campaign Day: " + this.point.x + "<br />";
...
function RenderHighChartsLineChart(jsonChartData) {
    ...
    if (_pageType != "campaign" && _tab == "OverTime")
    {
