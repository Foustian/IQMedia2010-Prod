...
namespace IQMedia.Web.Logic
{
    ...
    {
        public int InsertFeedsExport(Guid p_CustomerGuid, Boolean p_IsSelectAll, string p_SortType, string p_SearchCriteria, List<string> p_lstMediaIDs)
        {
            ...
            return iQService_FeedsDA.InsertFeedsExport(p_CustomerGuid, p_IsSelectAll, p_SortType, p_SearchCriteria, strMediaIDs);
        }
    }
}
