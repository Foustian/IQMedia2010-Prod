                ...
                if (result.isSuccess) {
                    if (!$("#chkMCAll").prop("checked")) {
                        $.each(mediaIDs, function (eventID, eventData) {
                            $("#imgPublished_" + eventData).removeClass("displayNone");
                        });
                    }
                    else {
                        $("img[id^='imgPublished_']").removeClass("displayNone");
                    }
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.isSuccess) {
                    if (!$("#chkMCAll").prop("checked")) {
                        $.each(mediaIDs, function (eventID, eventData) {
                            $("#imgPublished_" + eventData).addClass("displayNone");
                        });
                    }
                    else {
                        $("img[id^='imgPublished_']").addClass("displayNone");
                    }
