...
namespace IQMedia.WebApplication.Controllers
{
    ...
    public class TimeshiftController : Controller
    {
        ...
        public JsonResult SelectAllRadioStations()
        {
            ...
            try
            {
                if (sessionInformation.Isv4TimeshiftRadioAccess)
                {
                    ...
                    List<string> lstRadio = radioLogic.SelectRadioStations();
                    return Json(new
                    {
                        isSuccess = true,
                        market = lstRadio
        ...
        [HttpPost]
        public JsonResult SelectRadioStationResults(DateTime? p_FromDate, DateTime? p_ToDate, string p_Market, bool p_IsAsc, bool p_IsNext, bool p_IsPrevNext)
        {
            sessionInformation = CommonFunctions.GetSessionInformation();
            timeShiftTempData = GetTempData();
            ...
            try
            {
                ...
                {
                    long totalResults = 0;
                    long sinceID = timeShiftTempData.SinceID != null ? timeShiftTempData.SinceID.Value : 0;
                    int CurrentPage = (p_IsPrevNext && timeShiftTempData.CurrentPage != null) ? timeShiftTempData.CurrentPage.Value : 1;
                    ...
                    RadioLogic radioLogic = (RadioLogic)LogicFactory.GetLogic(LogicType.Radio);
                    List<RadioModel> lstRadio = radioLogic.SelectRadioResults(p_FromDate, p_ToDate, p_Market, p_IsAsc, CurrentPage, PageSize, ref sinceID, out totalResults);
                    ...
                    timeShiftTempData.SinceID = sinceID;
                    ...
                    return Json(new
                    {
                        ...
                        startRecord = (((CurrentPage - 1) * PageSize) + 1).ToString("N0"),
                        endRecord = ((CurrentPage * PageSize) < totalResults ? (CurrentPage * PageSize) : totalResults).ToString("N0"),
