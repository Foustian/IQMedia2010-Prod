    ...
    public class LibraryController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                resultdict.Add("ReportFolders", lstIQReport_FolderModel);
        ...
        private Dictionary<string, object> GetIQArchieveResults(long p_FromRecordID, string p_CustomerGuid, DateTime? p_FromDate, DateTime? p_ToDate, string p_SearchTerm, string p_SubMediaType, List<string> p_CategoryGUID, string p_SelectionType, bool p_IsAsc, string p_SortColumn, bool p_IsEnableFilter, int? p_PageSize)
        {
            ...
            dictResult = iQArchieveLogic.GetIQAgentMediaResults(ClientGUID, p_CustomerGuid,
                                                p_FromRecordID, PageSize, p_FromDate, p_ToDate, p_SubMediaType, p_SearchTerm, p_CategoryGUID, p_SelectionType, p_IsAsc, p_SortColumn, p_IsEnableFilter, Request.ServerVariables["HTTP_HOST"], ref sinceID, out totalResults, out totalResultsDisplay, sessionInformation.Isv4TM, customSettings.v4LibraryRollup);

            if (dictResult["Result"] != null)
            {
                List<IQArchive_MediaModel> lstArchiveMedia = CommonFunctions.GetGMTandDSTTime((List<IQArchive_MediaModel>)dictResult["Result"], CommonFunctions.ResultType.Library);
        ...
        public JsonResult FilterCategory(string p_CustomerGuid, DateTime? p_FromDate, DateTime? p_ToDate, string p_SearchTerm, string p_SubMediaType, List<string> p_CategoryGUID)
        {
            try
            {
                ...
                IQArchieveLogic iQArchieveLogic = (IQArchieveLogic)LogicFactory.GetLogic(LogicType.IQArchieve);
                List<IQArchive_Filter> lstCategoryFilter = iQArchieveLogic.GetCategoryFilter(ClientGUID, p_CustomerGuid, p_FromDate, p_ToDate, p_SubMediaType, p_SearchTerm, p_CategoryGUID, sinceID, sessionInformation.Isv4TM);
                                                    ...
                                                    Guid? p_SubCategory3Guid, string p_Keywords, string p_Description, bool? p_DisplayDescription)
        {
            try
            {
                ...
                iQArchieveLogic.Update_MediaRecord(p_ID, p_Title, p_CategoryGuid, p_SubCategory1Guid, p_SubCategory2Guid, p_SubCategory3Guid, p_Keywords, p_Description, p_DisplayDescription, new Guid(ClientGUID));
            ...
            try
            {
                        ...
                        (String.IsNullOrEmpty(BCCEmail) || BCCEmail.Split(new char[] { ';' }).Count() <= Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["MaxDefaultEmailAddress"])))
                {
                    ...
                    if (ReportID > 0)
                    {
                        ...
                        if (chartData.Count > 0)
                        {
                            string chartsHTML = "<div><div id='Overview'/><div id='TV'/><div id='NM'/><div id='Blog'/><div id='Forum'/><div id='SocialMedia'/><div id='TW'/><div id='PM'/><div id='MS'/></div>";
                            string attachmentId;
        ...
        private string GetCSVDataForReport(IQArchive_DisplayLibraryReport objDisplayLibraryReport)
        {
            if (objDisplayLibraryReport != null && objDisplayLibraryReport.ReportDetails != null && objDisplayLibraryReport.ArchiveResults != null)
            {
                ...
                bool hasFacebook = objDisplayLibraryReport.ArchiveResults.Where(w => w.SubMediaType == Shared.Utility.CommonFunctions.CategoryType.FB).Count() > 0;
                ...
                foreach (IQMedia.Model.IQArchive_MediaModel item in objDisplayLibraryReport.ArchiveResults)
                {
                    ...
                    switch (item.SubMediaType)
                    {
                        ...
                        case IQMedia.Shared.Utility.CommonFunctions.CategoryType.FB:
                            ...
                            if (hasFacebook)
                            {
                                if (item.SubMediaType == IQMedia.Shared.Utility.CommonFunctions.CategoryType.FB && socialModel.ArticleStats != null)
                                {
        ...
        public JsonResult FilterMCMediaCategory(string p_CustomerGuid, DateTime? p_FromDate, DateTime? p_ToDate, string p_SearchTerm, string p_SubMediaType, List<string> p_CategoryGUID)
        {
            try
            {
                ...
                IQArchieveLogic iQArchieveLogic = (IQArchieveLogic)LogicFactory.GetLogic(LogicType.IQArchieve);
                List<IQArchive_Filter> lstCategoryFilter = iQArchieveLogic.GetMCMediaCategoryFilter(ClientGUID, p_CustomerGuid, p_FromDate, p_ToDate, p_SubMediaType, p_SearchTerm, p_CategoryGUID, sinceID, sessionInformation.Isv4TM, sessionInformation.MCID, null);
                                                                ...
                                                                string p_SelectionType, bool p_IsAsc, string p_SortColumn, bool p_IsEnableFilter, int? p_PageSize, bool p_IsRefresh, bool p_UpdateTempData = true)
        {
            ...
            dictResult = iQArchieveLogic.GetMCMediaResults(ClientGUID, p_CustomerGuid, p_FromRecordID, PageSize, p_FromDate, p_ToDate, p_SubMediaType, p_SearchTerm, p_CategoryGUID, p_SelectionType, p_IsAsc, p_SortColumn, 
                                                            p_IsEnableFilter, Request.ServerVariables["HTTP_HOST"], ref sinceID, out totalResults, sessionInformation.Isv4TM, sessionInformation.MCID);
