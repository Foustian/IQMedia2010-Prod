...
namespace IQMedia.WebApplication.Controllers
{
    public class CheckAuthentication : ActionFilterAttribute
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (!IsValidSession || !Authentication.IsAuthenticated)
                    {
                        ...
                        HttpContext.Current.Session["SessionInformation"] = null;
                    ...
                    else
                    {
                        ...
                        if (IsValidSession)
                        {
                            ...
                            else
                            {
                                ...
                                if (currentUser != null)
                                {
                                    _CustomerID = currentUser.CustomerID;
        ...
        private bool CheckForAuthorization(string controllerName)
        {
            ...
            {
                SessionInformation session = IQMedia.WebApplication.Utility.CommonFunctions.GetSessionInformation();
                ...
                if (controllerName.ToUpper() == "IMAGIQ" && !session.isv4OptiqAccess)
                {
                    return false;
                }
