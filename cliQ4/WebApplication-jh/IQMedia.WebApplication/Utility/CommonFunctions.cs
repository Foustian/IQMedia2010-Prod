    ...
    public static class CommonFunctions
    {
        ...
        public static List<IQSolrEngineModel> ListOfSolrEngines {
            get
            {
                ...
                // - It was last retrieved more than an hour ago
                // - Month rollover has occurred
                bool getEngineData = _ListOfSolrEngines == null;
                getEngineData = getEngineData || (DateTime.Now - LastRefreshTime).Hours > 1 || (DateTime.Now.Day == 1 && LastRefreshTime.Day == DateTime.DaysInMonth(LastRefreshTime.Year, LastRefreshTime.Month));
                ...
                foreach (CustomerRoleModel customerrole in customerRoles)
                {
                    ...
                    switch (role)
                    {
                        ...
                        case IQMedia.Shared.Utility.CommonFunctions.Roles.v4Setup:
                            ...
                            break;
                        case IQMedia.Shared.Utility.CommonFunctions.Roles.v4Optiq:
                            customerModel.isv4OptiqAccess = true;
                            break;
        ...
        public static void UpdateUserIntoCache(string p_EmailAddress)
        {
            ...
            if (users != null && users.Count() > 0)
            {
                ...
                {
                    Logger.Fatal("UpdateUserCache: "+p_EmailAddress+"...users"+string.Join(",",users.Select(u=>u.LoginID)));
                }
            }

            /*if ((SessionModel.NextDBRefreshDateTime == null || SessionModel.NextDBRefreshDateTime <= DateTime.Now) && users != null)
            {
                var activeUsers = IQMedia.Shared.Utility.CommonFunctions.SerializeToXml(users);
            }*/
        }
        /*
        private static UpdateSessionTimeOutInDB(string p_SessionID,DateTime p_TimeOut)
        {
        ...
        */
        ...
        {
            Logger.Debug(HttpContext.Current.Session.SessionID + "Android device, checking version");
            ...
            Logger.Debug(HttpContext.Current.Session.SessionID + "Android device, version : " + version);
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        SetSessionInformation(customerModel);
