...
namespace IQMedia.Web.Logic
{
    public static class UtilityLogic
    {
        ...
        public static void WriteException(Exception _Exception, string Info = "")
        {
            try
            {

                SessionInformation sessionInformation = (SessionInformation)System.Web.HttpContext.Current.Session["SessionInformation"];
                ...
                iQMediaGroupExceptions.CustomerGuid = sessionInformation != null && !sessionInformation.CustomerGUID.Equals(Guid.Empty) ? sessionInformation.CustomerGUID : (Guid?)null;
        ...
        public static string GetRawMediaCaption(string searchTerm, Guid rawMediaID, out Int32? offset, out string fullCaption, string pmgurl, string p_Title120 = null, bool isOptiQ = false)
        {
            try
            {
                offset = null;
        ...
        private static string formatOffset(int offs)
        {
            int h = 0;
            int m = 0;
        ...
        public static void InsertFeedsSearchLog(int customerID, string mediaIDs, string mediaCategory, string excludeMediaCategories, DateTime? startDate, DateTime? endDate, string searchRequestIDs, string keyword, short? sentiment, string dma, string station, string competeUrl, int? iQDmaID, string handle,
                                                    string publication, string author, short? prominenceValue, bool isProminenceAudience, bool isAsc, bool? isAudienceSort, int pageSize, long? fromRecordID, long? sinceID, bool isOnlyParents, bool? isRead, string searchType, string response)
        {
            ...
            if (iQDmaID.HasValue)
            {
                _FileContent += "<IQDMAID>" + iQDmaID.Value + "</IQDMAID>";
            }
            else
            {
