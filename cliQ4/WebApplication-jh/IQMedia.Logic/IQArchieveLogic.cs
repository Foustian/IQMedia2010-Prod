...
namespace IQMedia.Web.Logic
{
    public class IQArchieveLogic : ILogic
    {
        ...
        public Dictionary<string, object> GetIQAgentMediaResults(string ClientGUID, string CustomerGUID, long FromRecordID, int PageSize, DateTime? FromDate, DateTime? ToDate, string SubMediaType, string SearchTerm,
                                                                List<string> CategoryGUID, string SelectionType, bool IsAsc, string SortColumn, bool IsEnableFilter, string currentUrl, ref long SinceID, out long TotalResults, out long TotalResultsDisplay, bool IsRadioAccess, bool IsLibraryRollup)
        {
            ...
            Dictionary<string, object> dictResult = iQArchieveDA.GetIQArchieveResults(ClientGUID, CustomerGUID, FromRecordID, PageSize, FromDate, ToDate, SubMediaType,
                                                                                        SearchTerm, strcategoryList, SelectionType, IsAsc, SortColumn, IsEnableFilter, currentUrl, ref SinceID, out TotalResults, out TotalResultsDisplay, IsRadioAccess, IsLibraryRollup);
            return dictResult;
        }
        ...
        {
            IQArchieveDA iQArchieveDA = (IQArchieveDA)DataAccessFactory.GetDataAccess(DataAccessType.IQArchieve);
            return iQArchieveDA.Update_MediaRecord(ID, Title, CategoryGuid, SubCategory1Guid, SubCategory2Guid, SubCategory3Guid, Keywords, Description, DisplayDescription, ClientGuid);
        }
        ...
        public List<IQArchive_Filter> GetCategoryFilter(string ClientGUID, string CustomerGUID, DateTime? FromDate, DateTime? ToDate, string SubMediaType, string SearchTerm, List<string> CategoryGUID, long SinceID, bool IsRadioAccess)
        {
            string strcategoryList = null;
            if (CategoryGUID != null && CategoryGUID.Count > 0)
            {
            ...
            IQArchieveDA iQArchieveDA = (IQArchieveDA)DataAccessFactory.GetDataAccess(DataAccessType.IQArchieve);
            return iQArchieveDA.GetCategoryFilter(ClientGUID, CustomerGUID, FromDate, ToDate, SubMediaType, SearchTerm, strcategoryList, SinceID, IsRadioAccess);
        }
        ...
        public List<IQArchive_Filter> GetMCMediaCategoryFilter(string ClientGUID, string CustomerGUID, DateTime? FromDate, DateTime? ToDate, string SubMediaType, string SearchTerm, List<string> CategoryGUID, long SinceID, bool IsRadioAccess, int? MasterClientID, string reportGUID)
        {
            string strcategoryList = null;
            if (CategoryGUID != null && CategoryGUID.Count > 0)
            {
            ...
            IQArchieveDA iQArchieveDA = (IQArchieveDA)DataAccessFactory.GetDataAccess(DataAccessType.IQArchieve);
            return iQArchieveDA.GetMCMediaCategoryFilter(ClientGUID, CustomerGUID, FromDate, ToDate, SubMediaType, SearchTerm, strcategoryList, SinceID, IsRadioAccess, MasterClientID, reportGUID);
        }
        ...
        public Dictionary<string, object> GetMCMediaResults(string ClientGUID, string CustomerGUID, long FromRecordID, int PageSize, DateTime? FromDate, DateTime? ToDate, string SubMediaType, string SearchTerm,
                                                                List<string> CategoryGUID, string SelectionType, bool IsAsc, string SortColumn, bool IsEnableFilter, string currentUrl, ref long SinceID, out long TotalResults, bool IsRadioAccess, int? MasterClientID)
        {
            string strcategoryList = null;
            if (CategoryGUID != null && CategoryGUID.Count > 0)
            {
            ...
            Dictionary<string, object> dictResult = iQArchieveDA.GetMCMediaResults(ClientGUID, CustomerGUID, FromRecordID, PageSize, FromDate, ToDate, SubMediaType,
                                                                                        SearchTerm, strcategoryList, SelectionType, IsAsc, SortColumn, IsEnableFilter, currentUrl, ref SinceID, out TotalResults, IsRadioAccess, MasterClientID);
            return dictResult;
        }
