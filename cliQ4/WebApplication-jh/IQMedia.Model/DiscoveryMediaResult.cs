...
namespace IQMedia.Model
{
    public class DiscoveryMediaResult
    {
        ...
        public Int32? TwitterFollowers { get; set; }
        public Int32? TwitterFriends { get; set; }
        public Int32? TwitterKLOutScore { get; set; }
        public string TwitterUserURL { get; set; }
        public string TwitterPrefferedName { get; set; }
        public string TwitterDisplayName { get; set; }
        public string TwitterActorLink { get; set; }
        public long TwitterTweetID { get; set; }
