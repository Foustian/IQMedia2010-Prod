...
namespace IQMedia.Model
{
    ...
    public class DiscoveryAdvanceSearchModel
    {
        ...
        public TwitterAdvanceSearchSettings TwitterSettings { get; set; }
    ...
    public class TwitterAdvanceSearchSettings
    {
        public string SearchTerm { get; set; }

        public string TwitterHandle { get; set; }

        public string FollowersFrom { get; set; }
        public string FollowersTo { get; set; }

        public string FollowingFrom { get; set; }
        public string FollowingTo { get; set; }

        public string KloutScoreFrom { get; set; }
        public string KloutScoreTo { get; set; }

        public List<string> ExcludeHandleList { get; set; }
    }
