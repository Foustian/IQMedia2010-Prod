    ...
    public class IQArchieveDA : IDataAccess
    {
        ...
        public IQArchive_EditModel GetIQArchiveByIDForEdit(string ClientGuid, long ID)
        {
            try
            {
                ...
                DataSet dataset = DataAccess.GetDataSet("usp_v4_IQArchive_Media_SelectByIDForEdit", dataTypeList);
        ...
        public string Update_MediaRecord(long ID, string Title, Guid? CategoryGuid, Guid? SubCategory1Guid, Guid? SubCategory2Guid,
                                                    Guid? SubCategory3Guid, string Keywords, string Description, bool? DisplayDescription, Guid ClientGuid)
        {
            try
            {
                List<DataType> dataTypeList = new List<DataType>();
                ...
                string result = DataAccess.ExecuteNonQuery("usp_v4_IQArchive_Media_UpdateMediaRecord", dataTypeList);
