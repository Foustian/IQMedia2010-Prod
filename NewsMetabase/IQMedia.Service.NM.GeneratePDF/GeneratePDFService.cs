    ...
    public partial class GeneratePDFService : ServiceBase
    {
        ...
        public void Run()
        {
            try
            {
                ...
                var baseAddress = new Uri("http://localhost:" + ConfigSettings.Settings.WCFServicePort + "/GeneratePDFWebService");

                _host = new ServiceHost(typeof(Service.GeneratePDFWebService), baseAddress);
