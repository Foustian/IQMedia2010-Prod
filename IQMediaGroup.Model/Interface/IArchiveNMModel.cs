...
namespace IQMediaGroup.Model.Interface
{
    public interface IArchiveNMModel
    {
        ...
        DataSet GetArchiveNMByArchiveNMKey(int p_ArchiveNMKey);

        DataSet GetArchiveNMReportGroupByCategory(Guid p_ClientGUID, DateTime p_Date);

        DataSet GetArchiveNMByCategoryGuidAndDate(Guid p_ClientGUID, string p_SortField, bool p_IsAscending, DateTime p_Date, Guid p_CategoryGuid);
