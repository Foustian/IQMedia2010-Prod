...
namespace IQMediaGroup.Model.Implementation
{
    ...
    internal class StatSkedProgModel : IQMediaGroupDataLayer, IStatSkedProgModel
    {
        ...
        /// <summary>
        /// Description: This method Gets the All Program Information For Default Search.
        /// Added By: Maulik Gandhi
        /// </summary>
        /// <returns>Dataset containing Program details.</returns>
        public DataSet GetDetailsForDefaultSearch(StatSkedProg _StatSkedProg)
        {
            try
            {
                DataSet _DataSet = new DataSet();
                ...
                _ListOfDataType.Add(new DataType("@ToDate", DbType.DateTime, _StatSkedProg.MaxDate, ParameterDirection.Input));
                _ListOfDataType.Add(new DataType("@IQ_Dma_Num", DbType.String, _StatSkedProg.IQ_Dma_Num, ParameterDirection.Input));
                _ListOfDataType.Add(new DataType("@IQ_class_Num", DbType.String, _StatSkedProg.IQ_Class_Num, ParameterDirection.Input));
                _ListOfDataType.Add(new DataType("@Title120", DbType.String, _StatSkedProg.Title120, ParameterDirection.Input));
                _ListOfDataType.Add(new DataType("@Desc100", DbType.String, _StatSkedProg.Desc100, ParameterDirection.Input));
                _ListOfDataType.Add(new DataType("@Station_Affil_Num", DbType.String, _StatSkedProg.Station_Affil_Num, ParameterDirection.Input));
                _ListOfDataType.Add(new DataType("@PageNumber", DbType.Int32, _StatSkedProg.PageNo, ParameterDirection.Input));
                _ListOfDataType.Add(new DataType("@PageSize", DbType.Int32, _StatSkedProg.PageSize, ParameterDirection.Input));
                _ListOfDataType.Add(new DataType("@SortField", DbType.String, _StatSkedProg.SortField, ParameterDirection.Input));
                _ListOfDataType.Add(new DataType("@IsAscending", DbType.Boolean, _StatSkedProg.IsAscending, ParameterDirection.Input));

                _DataSet = this.GetDataSet("usp_STATSKEDPROG_SelectForDefaultSearch", _ListOfDataType);
        ...
        public DataSet GetDetailByIQCCKeys(string p_IQCCKeys)
        {
            try
            {
                DataSet _DataSet = null;
                ...
                List<DataType> _ListOfDataType = new List<DataType>();
                _ListOfDataType.Add(new DataType("@IQCCKeys", DbType.String, p_IQCCKeys, ParameterDirection.Input));

                _DataSet = this.GetDataSet("usp_STATSKEDPROG_SelectByIQCCKeys", _ListOfDataType);
        ...
        public DataSet GetStatskedprogByParams(StatSkedProg _StatSkedProg)
        {
            try
            {
                DataSet _DataSet = new DataSet();
                ...
                _DataSet = this.GetDataSet("usp_STATSKEDPROG_SelectByParams", _ListOfDataType);
        ...
        public DataSet GetAllIQCCKeyByStatskedprogParams(StatSkedProg p_StatSkedProg)
        {
            try
            {
                DataSet _DataSet = null;
                ...
                _DataSet = this.GetDataSet("usp_STATSKEDPROG_SelectBySTATSKEDPROGParams", _ListOfDataType);
