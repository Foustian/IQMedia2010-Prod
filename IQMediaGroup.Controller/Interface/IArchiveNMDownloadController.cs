...
{
    public interface IArchiveNMDownloadController
    {
        List<ArchiveNMDownload> GetByCustomerGuid(Guid p_CustomerGuid);
        ...
        List<ArchiveNMDownload> GetArticleFileLocationAndStatus(string p_XML);
    }
}
