...
namespace IQMediaGroup.Controller.Interface
{
    ...
    public interface IRawMediaController
    {
        ...
        string GetChartData(String responseXML, String exporterName, String yAxisName, List<String> allStationCategoryNum, Dictionary<String, String> dictNumName);

        List<IQAgentIFrame> GetIqagentIframeData_ByiQAgentiFrameID(Guid iQAgentiFrameID);
