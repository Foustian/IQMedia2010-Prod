                                                ...
                                                <asp:Repeater ID="rptTV" runat="server" OnItemCommand="rptTV_ItemCommand">
                                                    ...
                                                    <ItemTemplate>
                                                        <div class="clear grid">
                                                            ...
                                                            <div style="width: 9%;" class="right">
                                                                <span>
                                                                    <%# string.IsNullOrEmpty(Convert.ToString(Eval("IQNielenseAudience"))) ? "NA" : Convert.ToInt64(Eval("IQNielenseAudience")).ToString("N0")%></span>
                                                            </div>
                                                            <div runat="server" id="divAdShare" style="width: 9%;" class="right">
                                                                <span>
                                                                    <%# string.IsNullOrEmpty(Convert.ToString(Eval("IQAddShareValue"))) ? "NA" : Convert.ToInt64(Eval("IQAddShareValue").ToString().Split('(')[0]).ToString("N") + '(' + Eval("IQAddShareValue").ToString().Split('(')[1]%></span>
                                                            </div>
