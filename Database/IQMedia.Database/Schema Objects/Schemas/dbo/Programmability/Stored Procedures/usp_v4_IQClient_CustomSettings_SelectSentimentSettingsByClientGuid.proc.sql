CREATE PROCEDURE [dbo].[usp_v4_IQClient_CustomSettings_SelectSentimentSettingsByClientGuid]
...
BEGIN
	...
	FROM
			...
			(
				MAX(Value) 
				FOR Field IN([TVLowThreshold],[TVHighThreshold],[NMLowThreshold],[NMHighThreshold],[SMLowThreshold],[SMHighThreshold],[TwitterLowThreshold],[TwitterHighThreshold],[PQLowThreshold],[PQHighThreshold])	
			) b			
END