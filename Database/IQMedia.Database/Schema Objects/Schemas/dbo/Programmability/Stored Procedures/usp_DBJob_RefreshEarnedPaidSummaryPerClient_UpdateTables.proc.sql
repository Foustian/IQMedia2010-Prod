...
/****** Object:  StoredProcedure [dbo].[usp_DBJob_RefreshEarnedPaidSummaryPerClient_UpdateTables]    Script Date: 10/20/2016 3:11:35 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[usp_DBJob_RefreshEarnedPaidSummaryPerClient_UpdateTables]  (      
...
BEGIN         
 ...
 BEGIN TRY 
	...
	DELETE IQAgent_EarnedPaidDaySummary WHERE _ClientGUID = @ClientGUID
	DELETE IQAgent_EarnedPaidHourSummary WHERE _ClientGUID = @ClientGUID
	...
	MERGE INTO IQAgent_EarnedPaidDaySummary AS TARGET
		  ...
		  INSERT(_ClientGuid,DayDate,_SearchRequestID,Market,CountryNumber,
				...
				LtSeen_Earned,LtSeen_Paid,LtHeard_Earned,LtHeard_Paid,LastUpdated) VALUES
				(ClientGuid,DayDate,SearchRequestID,Market,CountryNumber,ISNULL(NumberOfDocs,0),ISNULL(NumberOfHits,0),
				ISNULL(AM18_20,0),ISNULL(AM21_24,0),ISNULL(AM25_34,0),ISNULL(AM35_49,0),ISNULL(AM50_54,0),ISNULL(AM55_64,0),ISNULL(AM65_Plus,0),
				ISNULL(AF18_20,0),ISNULL(AF21_24,0),ISNULL(AF25_34,0),ISNULL(AF35_49,0),ISNULL(AF50_54,0),ISNULL(AF55_64,0),ISNULL(AF65_Plus,0),
				ISNULL(TotalAudience,0),ISNULL(PositiveSentiment,0),ISNULL(NegativeSentiment,0),ISNULL(IQAdShareValue,0),
				ISNULL(Seen_Earned,0),ISNULL(Seen_Paid,0),ISNULL(Heard_Earned,0),ISNULL(Heard_Paid,0),GETDATE());
 ...
 BEGIN CATCH        
   ...
   DECLARE @IQMediaGroupExceptionKey BIGINT,
		...
		SELECT 
				...
				@CreatedBy='usp_DBJob_RefreshEarnedPaidSummaryPerClient_UpdateTables',
				@ModifiedBy='usp_DBJob_RefreshEarnedPaidSummaryPerClient_UpdateTables',
				@CreatedDate=GETDATE(),
