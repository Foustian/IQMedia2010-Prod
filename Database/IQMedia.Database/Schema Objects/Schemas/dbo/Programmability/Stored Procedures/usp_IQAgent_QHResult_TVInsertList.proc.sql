...
/****** Object:  StoredProcedure [dbo].[usp_IQAgent_QHResult_TVInsertList]    Script Date: 3/16/2016 2:12:27 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[usp_IQAgent_QHResult_TVInsertList]                             
(        
 @XmlData   XML        
)          
AS        
  ...
  SELECT         
   ...
   BEGIN TRANSACTION
	 ...
	 SELECT
		...
		tvTmp.Paid FROM @IQAgent_QHTVResults tvTmp
