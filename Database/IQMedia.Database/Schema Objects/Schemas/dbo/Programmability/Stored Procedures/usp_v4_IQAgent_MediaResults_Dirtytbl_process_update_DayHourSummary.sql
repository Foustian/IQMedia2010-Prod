...
/****** Object:  StoredProcedure [dbo].[usp_v4_IQAgent_MediaResults_Dirtytbl_process_update_DayHourSummary]    Script Date: 8/12/2015 10:54:56 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[usp_v4_IQAgent_MediaResults_Dirtytbl_process_update_DayHourSummary]
...
Merge Into #TmpDaySummaryResults As Target
							Using #TmpDaySummaryResults_Archive AS Source
...
Merge Into #TmpDaySummaryLDResults As Target
							Using #TmpDaySummaryLDResults_Archive AS Source
...
Merge Into #TmpHourSummaryResults As Target
							Using #TmpHourSummaryResults_Archive AS Source
...
Begin Transaction			
							...
							Join #MediaResults mr on mr.DirtyTableID = dt.ID -- and dt.IsActive=1
...
END TRY
		BEGIN CATCH
			...
			SELECT 
				...
				@CreatedBy='usp_v4_IQAgent_MediaResults_Dirtytbl_process_update_DayHourSummary]',
				@ModifiedBy='usp_v4_IQAgent_MediaResults_Dirtytbl_process_update_DayHourSummary]',
				@CreatedDate=GETDATE(),
