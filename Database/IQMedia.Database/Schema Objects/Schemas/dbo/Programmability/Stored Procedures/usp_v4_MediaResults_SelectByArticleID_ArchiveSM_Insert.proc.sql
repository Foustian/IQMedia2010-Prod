CREATE PROCEDURE [dbo].[usp_v4_MediaResults_SelectByArticleID_ArchiveSM_Insert]  
...
BEGIN  
 ...
 -- First, Read from IQAgent_SMResults
      ...
      BEGIN  
       ...
       INSERT INTO   
          ...
          SELECT    
            ...
            @HighLightText,
			CASE   
				WHEN @SourceCategory = 'Blog' OR @SourceCategory = 'Comment' THEN 'Blog'  
				WHEN @SourceCategory = 'Forum' OR @SourceCategory = 'Review' THEN 'Forum'  
				ELSE 'SocialMedia'  
            END   
       ...
       INSERT INTO IQArchive_Media  
          ...
          (  
		   ...
		   @Content,
			CASE   
				WHEN @SourceCategory = 'Blog' OR @SourceCategory = 'Comment' THEN 'BL'  
				WHEN @SourceCategory = 'Forum' OR @SourceCategory = 'Review' THEN 'FO'  
				ELSE 'SM'  
            END,
			CASE   
				WHEN @SourceCategory = 'Blog' OR @SourceCategory = 'Comment' THEN 'Blog'  
 ...
 BEGIN CATCH  
  ...
  SELECT   
    ...
    @CreatedBy='usp_v4_MediaResults_SelectByArticleID_ArchiveSM_Insert',  
    @ModifiedBy='usp_v4_MediaResults_SelectByArticleID_ArchiveSM_Insert',  
    @CreatedDate=GETDATE(),  
