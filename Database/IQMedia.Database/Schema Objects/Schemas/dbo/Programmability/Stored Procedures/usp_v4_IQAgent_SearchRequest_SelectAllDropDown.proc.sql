-- =============================================
-- Author:		<Author,,Name>
-- Create date: 7 August 2013
-- Description:	Select all the required dropdown for Setup -> IQAgentSetup
-- =============================================
CREATE PROCEDURE [dbo].[usp_v4_IQAgent_SearchRequest_SelectAllDropDown]
...
BEGIN
	...
	ELSE
		BEGIN
			insert into @StationTable
			SELECT 
					DISTINCT IQ_Station_ID,Station_Call_Sign,Station_Affil
			FROM  IQ_Station
			Inner join @DistractRegions Reg
						ON IQ_Station.Region_num=Reg.Region_Num
			Inner join @DistractCountry Country
	...
	SELECT ID,Lable AS Label,Value FROM SM_SourceCategory	WHERE IsActive = 1 ORDER BY Order_Number
