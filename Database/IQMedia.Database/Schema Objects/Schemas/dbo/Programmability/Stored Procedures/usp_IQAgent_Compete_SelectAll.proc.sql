CREATE PROCEDURE [dbo].[usp_IQAgent_Compete_SelectAll]
AS
BEGIN
	...
	FROM IQ_CompeteAll
	WHERE CompeteURL IS NOT NULL AND c_uniq_visitor IS NOT NULL AND CompeteURL NOT IN ('facebook.com', 'twitter.com', 'friendfeed.com')
