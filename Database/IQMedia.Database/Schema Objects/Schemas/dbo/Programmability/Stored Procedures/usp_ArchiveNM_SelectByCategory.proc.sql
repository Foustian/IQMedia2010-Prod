CREATE PROCEDURE [dbo].[usp_ArchiveNM_SelectByCategory]
...
BEGIN
	...
	SET @Query = @Query + ' WHERE
			...
			ANd ARchiveNM.CategoryGuid = '''+ CONVERT(varchar(40),@CategoryGUID) +'''
			AND CONVERT(date,ARchiveNM.CreatedDate) = CONVERT(date,'''+CONVERT(varchar(10),@ArticleDate) +''')
