CREATE PROCEDURE [dbo].[usp_v4_IQDashboard_GoogleSummary_SelectByMonth]  
	@FromDate DATE,
	@ToDate DATE,
...
BEGIN  
	...
	SELECT	MAX(GoogleLocalDateTime) AS DayDate,
	...
	GROUP	BY DATEPART(YEAR, GoogleLocalDateTime), DATEPART(MONTH, GoogleLocalDateTime)
