...
//		}
		...
		public function SizeItems():void
		{
			...
			volbutt_mc.x=Math.round(botbar_mc.width - 25);
			volbutt_mc.y=botbar_mc.y + 7;
			mutebutt_mc.x=Math.round(botbar_mc.width - 25);
			...
			//menuStopx=0;
			//menuStopy=Math.round(botbar_mc.y + (38 * wchange));
			//menuStartx=0;
