<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IQAgent.aspx.cs" Inherits="IQMediaGroup.WebApplication.Report.IQAgent" %>

<%@ Register Src="~/UserControl/IQMediaMaster/IQAgentReport/IQAgentReport.ascx" TagName="UCIQAgentReport"
    TagPrefix="uc2" %>
...
<body  >
    ...
    <uc2:UCIQAgentReport ID="UCIQAgentReport1" runat="server"></uc2:UCIQAgentReport>
    </form>
