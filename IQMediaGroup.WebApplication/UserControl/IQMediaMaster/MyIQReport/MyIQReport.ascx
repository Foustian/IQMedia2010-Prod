                                        ...
                                        <div id="divReportTypeFilter">
                                            ...
                                            <div id="ReportFilters" class="clear paddingtop15">
                                                <div id="divDailyReport" runat="server">
                                                    ...
                                                    <asp:RequiredFieldValidator ValidationGroup="vgReport" ID="rfvtxtReportDate" runat="server"
                                                        ControlToValidate="txtReportDate" ErrorMessage="Please Enter Report Date" Display="None">
                                                    </asp:RequiredFieldValidator>
                                                    <asp:CompareValidator ID="CompareValidator1" ControlToValidate="txtReportDate" Display="None"
                                                        runat="server" Operator="DataTypeCheck" Type="Date" ErrorMessage="Please Enter Valid Date"
...
<asp:Panel ID="divClipPlayer" runat="server" Style="display: none;" 
    CssClass="modal hide fade resizable playerPopUp">
