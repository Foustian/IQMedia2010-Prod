...
<div id="wrapper">
    ...
    <div class="banner">
     ...
     <div id="banner"><img  id="imgBanner" runat="server" src=''></div>
    <%-- <script type="text/javascript">
         var html = document.getElementById("banner");
         var r = Math.random();
         if (r > 0.5) {
             html.innerHTML = "<a href='pdf/PL1-cliQ-4-pages.pdf' target='_blank' class='leadinbox'><img src='images/home/banner01.png'></a> ";
    ...
    <div class="content-main">
        ...
        <img id="imgSubBanner" runat="server" src="" alt="">
</div>
       ...
       <div id="show">
       <a href='pdf/PL1-cliQ-4-pages.pdf' target='_blank' class='leadinbox'><img src='images/home/home-img02.png'></a> <a target="_blank" href='http://www.iqmediacorp.com/ClipPlayer/default.aspx?ClipID=ce641edb-44c4-4e73-aabb-32c3f0f61f4e&TE=nb%2fdH9YSimVlgeHlRzMuFAYD3wKa6p4GCFMFEirCGeQ%3d&PN=bt9sZFac%2bKA%3d' class='leadinbox'><img src='images/home/home-img03.png'></a> <a href='pdf/WP01-Overcoming-TMS-Limits.pdf' target='_blank' class='leadinbox'><img src='images/home/home-img01.png'></a>
       </div>
      <%-- <script type="text/javascript">
           var html = document.getElementById("show");
                      var r = Math.random();
                      if (r > 0.5) {
           html.innerHTML = "<a href='pdf/PL1-cliQ-4-pages.pdf' target='_blank' class='leadinbox'><img src='images/home/home-img02.png'></a> <a href='javascript:;' class='leadinbox'><img src='images/home/home-img03.png'></a> <a href='pdf/WP01-Overcoming-TMS-Limits.pdf' target='_blank' class='leadinbox'><img src='images/home/home-img01.png'></a> ";
