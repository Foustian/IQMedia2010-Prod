<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DownloadArchiveNM.ascx.cs" Inherits="IQMediaGroup.Usercontrol.IQMediaMaster.DownloadArchiveNM.DownloadArchiveNM" %>
