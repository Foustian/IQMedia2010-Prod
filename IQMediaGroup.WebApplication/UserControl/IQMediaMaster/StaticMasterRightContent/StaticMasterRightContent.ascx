...
<script type="text/javascript" >
    ...
    var GetWhiltePaper = '<a href="../pdf/WP01-Overcoming-TMS-Limits.pdf" target="_blank"><img src="../images/about/about-img01.png"></a>';
    var LearnMore = '<a href="../pdf/PL1-cliQ-4-pages.pdf" target="_blank"><img src="../images/about/about-img02.png"></a>';
    ...
    var OptimizedCloud = '<a href="../pdf/PL2-Media-Cloud.pdf" target="_blank"><img src="../images/about/about-img04.png"></a>';
    var QuickFacts = '<a href="../pdf/PL1-cliQ-2-pages.pdf" target="_blank"><img src="../images/about/about-img07.png"></a>';
    var LearnInlineWorkShop = '<a href="../pdf/PL2-Inline-Workspace.pdf" target="_blank"><img src="../images/about/about-img05.png"></a>';
    var LearnMyiQ = '<a href="../pdf/PL2-My-iQ.pdf" target="_blank"><img src="../images/about/about-img06.png"></a>';
...
<div id="divProducts" runat="server" visible="false">
    <div class="about-right-bg" id="TakeTourContent"></div>
    <div class="about-right-bg" id="GetWhiltePaper" ></div>
...
<div id="divOptimizedCloud" runat="server" visible="false">
    <div class="about-right-bg" id="TakeTourContent"  ></div>
    <div class="about-right-bg" id="OptimizedCloud"></div>
    <div class="about-right-bg" id="QuickFacts" ></div>
    <div class="about-right-bg" id="SeeProPrep" ></div>
     <script type="text/javascript" >
         GetContent("TakeTourContent");
...
<div id="divInlineWorkShop" runat="server" visible="false">
    <div class="about-right-bg" id="TakeTourContent" ></div>
    <div class="about-right-bg" id="LearnInlineWorkShop" ></div>
    <div class="about-right-bg" id="GetWhiltePaper" ></div>
    <div class="about-right-bg" id="SeeProPrep" ></div>
     <script type="text/javascript" >
         GetContent("TakeTourContent");
...
<div id="divMyiQ" runat="server" visible="false">
    <div class="about-right-bg" id="TakeTourContent" ></div>
    <div class="about-right-bg" id="LearnMyiQ"></div>
    <div class="about-right-bg" id="QuickFacts" ></div>
    <div class="about-right-bg" id="SeeProPrep" ></div>
     <script type="text/javascript" >
         GetContent("TakeTourContent");
