 ...
 */
public class testIQMStatus {
 public boolean Indexing_Started=true;
    public String Index_Start_time="";
    ...
    public static class SQLDB_Index_Update
    {
        ...
        private int No_rows_fetched;
        private int No_rows_updated;
        ...
        public void setNo_rows_fetched(int p_No_rows_fetched)
        {
            No_rows_fetched=p_No_rows_fetched;
        }

        public void setNo_rows_updated(int p_No_rows_updated)
        {
            No_rows_updated=p_No_rows_updated;
        }
        ...
        public int getNo_rows_fetched()
        {
            return No_rows_fetched;
        }

        public int getNo_rows_updated()
        {
