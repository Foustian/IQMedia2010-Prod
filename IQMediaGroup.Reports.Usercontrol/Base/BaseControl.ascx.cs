...
namespace IQMediaGroup.Reports.Usercontrol.Base
{
    public partial class BaseControl : System.Web.UI.UserControl
    {
        ...
        public void WriteException(Exception _Exception)
        {
            try
            {
                ...
                _IQMediaGroupExceptions.ExceptionStackTrace = "Inner Exception : " + _Exception.InnerException + " Stack Trace : " + _Exception.StackTrace;
        ...
        public void SetViewstateInformation(IQMediaGroup.Core.HelperClasses.ViewstateInformation p_ViewstateInformation)
        {
            try
            {
        ...
        public IQMediaGroup.Core.HelperClasses.ViewstateInformation GetViewstateInformation()
        {
        ...
        public void SetViewStateInformationIframe(ViewStateInformationIframe p_ViewStateInformationIframe)
        {
            try
            {
                ViewState["ViewstateInformationIframe"] = p_ViewStateInformationIframe;
            }
            catch (Exception _Exception)
            {                
                throw _Exception;
        ...
        public ViewStateInformationIframe GetViewStateInformationIframe()
        {
            try
            {
                ViewStateInformationIframe _ViewStateInformationIframe = null;

                _ViewStateInformationIframe = (ViewStateInformationIframe)ViewState["ViewstateInformationIframe"];

                if (_ViewStateInformationIframe == null) _ViewStateInformationIframe = new ViewStateInformationIframe();

                return _ViewStateInformationIframe;
            }
            catch (Exception _Exception)
            {                
                throw _Exception;
