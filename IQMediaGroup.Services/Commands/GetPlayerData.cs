...
{
    public class GetPlayerData : ICommand
    {
        public Guid? _ID { get; private set; }
        public string _Type { get; private set; }
        private String _EncryptedID;
        public GetPlayerData(object ID, object Type)
        {
        ...
        public void Execute(HttpRequest HttpRequest, HttpResponse HttpResponse)
        {
            ...
            try
            {
                ...
                dynamic Result = PlayerDataLogic.GetPlayerData(_ID, _Type, BaseCommand.GeneratePMGUrl(BaseCommand.PMGUrlType.TV.ToString(), null, null), BaseCommand.GeneratePMGUrl(BaseCommand.PMGUrlType.QR.ToString(), null, null));
