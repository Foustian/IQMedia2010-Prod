...
{
    public class GetHighlightedSMWithDate : ICommand
    {
        ...
        public GetHighlightedSMWithDate(object ID, object Format, object ArticleID, object SearchTerm, object FragSize,object Date)
        {
            ...
            try
            {
                ...
                if (_ID != null)
                {
                    ...
                    else
                    {
                        ...
                        List<string> listofHighlights = highlightedSMLogic.GetSMHighlight(iQAgentSearchTerm.SearchTerm, iQAgentSearchTerm.ArticleID, _FragSize,out hasResult,_PmgUrl);
                ...
                {
                    string _PmgUrl = BaseCommand.GeneratePMGUrl(BaseCommand.PMGUrlType.MO.ToString(), _Date);
                    List<string> listofHighlights = highlightedSMLogic.GetSMHighlight(_SearchTerm, _ArticleID, _FragSize, out hasResult, _PmgUrl);
                    highlightedSMOutput.Highlights = listofHighlights;
                }
