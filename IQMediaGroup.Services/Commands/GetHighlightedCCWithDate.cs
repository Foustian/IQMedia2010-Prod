...
{
    public class GetHighlightedCCWithDate : ICommand
    {
        ...
        public GetHighlightedCCWithDate(object ID, object Format, object IQ_CC_Key, object SearchTerm, object FragOffset,object Date)
        {
            ...
            try
            {
                ...
                if (_ID != null)
                {
                    ...
                    else
                    {
                        ...
                        List<ClosedCaption> listofCC = highlightedCCLogic.GetClosedCaption(iQAgentRawMedia.SearchTerm, iQAgentRawMedia.RL_VideoGUID, string.Empty, _FragOffset, out hasResult, _PmgUrl);
                ...
                {
                    string _PmgUrl = BaseCommand.GeneratePMGUrl(BaseCommand.PMGUrlType.TV.ToString(), _Date);
                    List<ClosedCaption> listofCC = highlightedCCLogic.GetClosedCaption(_SearchTerm, Guid.Empty, _IQ_CC_Key, _FragOffset, out hasResult, _PmgUrl);
