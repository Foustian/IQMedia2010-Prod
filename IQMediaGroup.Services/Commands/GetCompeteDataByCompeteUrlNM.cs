...
{
    public class GetCompeteDataByCompeteUrlNM : ICommand
    {
        public String _Format { get; private set; }

        public GetCompeteDataByCompeteUrlNM(object Format)
        {
        ...
        public void Execute(HttpRequest HttpRequest, HttpResponse HttpResponse)
        {
            ...
            CLogger.Debug("Get NM CompeteDataByURL  Request Started");
            ...
            try
            {
                ...
                _CompeteUrlOutput = _CompeteDataLogic.GetCompeteByCompeteURL(_CompeteUrlInput, CommonConstants.MediaType.NM);
            }
            ...
            else
            {
                ...
                _Output = Serializer.Searialize(_CompeteUrlOutput);
            }
            ...
            CLogger.Debug("Get NM CompeteDataByURL  Request Ended");
