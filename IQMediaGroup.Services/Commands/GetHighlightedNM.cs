...
{
    public class GetHighlightedNM : ICommand
    {
        ...
        public GetHighlightedNM(object ID, object Format, object ArticleID, object SearchTerm, object FragSize)
        {
        ...
        public void Execute(HttpRequest HttpRequest, HttpResponse HttpResponse)
        {
            ...
            try
            {
                ...
                if (_ID != null)
                {
                    ...
                    {
                        List<string> listofHighlights = highlightedNewsLogic.GetNewsHighlight(iQAgentSearchTerm.SearchTerm, iQAgentSearchTerm.ArticleID, _FragSize, out hasResult, BaseCommand.GeneratePMGUrl(BaseCommand.PMGUrlType.MO.ToString(), null, null));
                ...
                {
                    List<string> listofHighlights = highlightedNewsLogic.GetNewsHighlight(_SearchTerm, _ArticleID.Value.ToString(), _FragSize, out hasResult, BaseCommand.GeneratePMGUrl(BaseCommand.PMGUrlType.MO.ToString(), null, null));
