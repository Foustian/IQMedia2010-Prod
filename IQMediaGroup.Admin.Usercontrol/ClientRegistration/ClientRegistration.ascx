...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#ctl00_Content_Data_ClientRegistration1_rptRoles input[id$="_chkSelectRole"]').unbind("click").click(function () {
            var lblRole = $(this).closest('table[id="tblChkBox"]').find('span[id$="_lblRole"]')[0];
            if (lblRole.innerHTML == "CompeteData") {
                if ($(this).is(':checked')) {
                    $('tr[id$="trCompete"]').show();
                    $('input[id$="_hdnIsCompeteSelected"]').val(1);
                }
                else {
                    $('tr[id$="trCompete"]').hide();
                    $('input[id$="_hdnIsCompeteSelected"]').val(0);
                }
                ...
                <tr>
                    <td>
                        <div onkeydown="PopUpButtonSubmit(event, this);">
                            <asp:Panel ID="pnlMailPanel" Style="vertical-align: middle; min-height: 500px; max-height: 665px;
                                display: none;" DefaultButton="btnSave" runat="server" ScrollBars="Auto">
                                    ...
                                    <tr>
                                        <td valign="top" bgcolor="#FFFFFF">
                                            <table border="0" align="center" style="vertical-align: middle;" cellpadding="0"
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:HiddenField ID="hdnIsCompeteSelected" runat="server" Value="0" />
                                                        <table width="100%" style="vertical-align: middle" border="0" align="center" cellpadding="0"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left" valign="top" style="vertical-align: top;">
                                                                                            <AjaxToolkit:ComboBox ID="ddlMasterClient" runat="server" CssClass="EditCombobox"
                                                                                                RenderMode="Inline" MaxLength="50" AutoPostBack="false" DropDownStyle="DropDown"
                                                                ...
                                                                <td align="left">
                                                                    <table border="0" cellspacing="10" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:Label ID="lblMsgFileType" runat="server" Font-Bold="true"></asp:Label>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="80px">
                                                                            ...
                                                                            <td align="left">
                                                                                ...
                                                                                <asp:Label ID="lblCustomHeaderSize" runat="server" Font-Bold="true"></asp:Label>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                            ...
                                                                            <td align="left">
                                                                                ...
                                                                                <asp:Label ID="lblPlayerLogoSize" runat="server" Font-Bold="true"></asp:Label>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td class="content-text" style="width: 150px;">
                                                                                Total No Of IQ Notification
                                                                            </td>
                                                                            <td style="width: 250px;">
                                                                                <label>
                                                                                    <asp:TextBox ID="txtTotalNoOfIQNotification" runat="server" CssClass="textbox03"></asp:TextBox>
                                                                                    <AjaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server"
                                                                                        TargetControlID="txtTotalNoOfIQNotification" FilterMode="InvalidChars" FilterType="Numbers,UppercaseLetters,LowercaseLetters,Custom"
                                                                                        InvalidChars="<>">
                                                                                    </AjaxToolkit:FilteredTextBoxExtender>
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtTotalNoOfIQNotification"
                                                                                        ErrorMessage="Please Enter Valid No of IQ Notification." Text="*" ValidationExpression="^\d+$"
                                                                                        ValidationGroup="validateClient"></asp:RegularExpressionValidator>
                                                                                </label>
                                                                            </td>
                                                                            <td class="content-text" style="width: 150px;">
                                                                                Total No Of IQ IQ Agent
                                                                            </td>
                                                                            <td style="width: 250px;">
                                                                                <label>
                                                                                    <asp:TextBox ID="txtTotalNoOfIQAgent" runat="server" CssClass="textbox03"></asp:TextBox>
                                                                                    <AjaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server"
                                                                                        TargetControlID="txtTotalNoOfIQAgent" FilterMode="InvalidChars" FilterType="Numbers,UppercaseLetters,LowercaseLetters,Custom"
                                                                                        InvalidChars="<>">
                                                                                    </AjaxToolkit:FilteredTextBoxExtender>
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtTotalNoOfIQAgent"
                                                                                        ErrorMessage="Please Enter Valid No of IQ Agent." Text="*" ValidationExpression="^\d+$"
                                                                                        ValidationGroup="validateClient"></asp:RegularExpressionValidator>
                                                                                </label>
                                                                            </td>
                                                                        </tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div id="trCompete" runat="server" style="display: none;">
                                                                        <table width="100%">
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td class="content-text" style="width: 130px;">
                                                                                    Compete Multiplier
                                                                                </td>
                                                                                <td style="width: 200px;">
                                                                                    <label>
                                                                                        <asp:TextBox ID="txtCompeteMultiplier" runat="server" CssClass="textbox03"></asp:TextBox>
                                                                                        <AjaxToolkit:FilteredTextBoxExtender ID="ftbtxtCompeteMultiplier" runat="server"
                                                                                            TargetControlID="txtCompeteMultiplier" FilterMode="ValidChars" FilterType="Custom,Numbers"
                                                                                            ValidChars=".">
                                                                                        </AjaxToolkit:FilteredTextBoxExtender>
                                                                                        <asp:RegularExpressionValidator ID="retxtCompeteMultiplier" ValidationExpression="\d+(\.\d{1,2})?"
                                                                                            runat="server" ControlToValidate="txtCompeteMultiplier" ErrorMessage="Please Enter Valid Compete Multiplier"
                                                                                            Text="*" ValidationGroup="validateClient">
                                                                                ...
                                                                                <td style="width: 200px;">
                                                                                    <label>
                                                                                        <asp:TextBox ID="txtCompeteNewsAdRate" runat="server" CssClass="textbox03"></asp:TextBox>
                                                                                        <AjaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender9" runat="server"
                                                                                            TargetControlID="txtCompeteNewsAdRate" FilterMode="ValidChars" FilterType="Custom,Numbers"
                                                                                            ValidChars=".">
                                                                                        </AjaxToolkit:FilteredTextBoxExtender>
                                                                                        <asp:RegularExpressionValidator ID="retxtCompeteNewsAdRate" ValidationExpression="\d+(\.\d{1,2})?"
                                                                                            runat="server" ControlToValidate="txtCompeteNewsAdRate" ErrorMessage="Please Enter Valid Compete News Ad Rate"
                                                                                            Text="*" ValidationGroup="validateClient">
                                                                                        </asp:RegularExpressionValidator>
                                                                                    </label>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td class="content-text" style="width: 130px;">
                                                                                    Other Online Ad Rate
                                                                                </td>
                                                                                <td style="width: 200px;">
                                                                                    <label>
                                                                                        <asp:TextBox ID="txtCompeteDefaultAdRate" runat="server" CssClass="textbox03"></asp:TextBox>
                                                                                        <AjaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender10" runat="server"
                                                                                            TargetControlID="txtCompeteDefaultAdRate" FilterMode="ValidChars" FilterType="Custom,Numbers"
                                                                                            ValidChars=".">
                                                                                        </AjaxToolkit:FilteredTextBoxExtender>
                                                                                        <asp:RegularExpressionValidator ID="retxtCompeteDefaultAdRate" ValidationExpression="\d+(\.\d{1,2})?"
                                                                                            runat="server" ControlToValidate="txtCompeteDefaultAdRate" ErrorMessage="Please Enter Valid Compete Default Ad Rate"
                                                                                            Text="*" ValidationGroup="validateClient">
                                                                                        </asp:RegularExpressionValidator>
                                                                                    </label>
                                                                                </td>
                                                                                ...
                                                                                <td style="width: 200px;">
                                                                                    <label>
                                                                                        <asp:TextBox ID="txtCompeteURLPercentRead" runat="server" CssClass="textbox03"></asp:TextBox>
                                                                                        <AjaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender11" runat="server"
                                                                                            TargetControlID="txtCompeteURLPercentRead" FilterMode="ValidChars" FilterType="Custom,Numbers"
                                                                                            ValidChars=".">
                                                                                        </AjaxToolkit:FilteredTextBoxExtender>
                                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator5" ValidationExpression="\d+(\.\d{1,2})?"
                                                                                            runat="server" ControlToValidate="txtCompeteURLPercentRead" ErrorMessage="Please Enter Valid URL Percent Read"
                                                                                            Text="*" ValidationGroup="validateClient">
                                                                                        </asp:RegularExpressionValidator>
                                                                                    </label>
                                                                                </td>
                                                                                ...
                                                                                <table border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td>
                                                                                            ...
                                                                                            <asp:DataList ID="rptRoles" runat="server" RepeatColumns="3" CellPadding="0" CellSpacing="0">
                                                                                                <ItemTemplate>
                                                                                                    <table cellpadding="5" id="tblChkBox" cellspacing="0" width="100%">
                                                                                                        <tr height="29px;">
                                                                                                            <%--  <td width="15" height="100%" valign="top">
                                                                                                                    <%# Container.ItemIndex+1 %>
                                                                                                                </td>--%>
                                                                                                            <td width="120" height="100%" valign="middle">
                                                                                                            ...
                                                                                                            <td valign="middle" align="right" width="30" height="100%">
                                                                                                                <asp:CheckBox ID="chkSelectRole" onclick="checkCompete(this)" runat="server" />
                                                                                                            </td>
                                                                                                            <td width="45px">
                                                                                                                &nbsp;
                                                                                                            </td>
