...
namespace IQMediaGroup.Admin.Model.Interface
{
    ...
    public interface ICustomerModel
    {
        ...
        DataSet GetMyClipByClientID(Customer p_Customer);
        ...
        DataSet GetCustomerInfoBySearchTerm(string p_prefixText);

        DataSet GetCustomerInfoByFirstName(string p_FirstName);
    }
}
