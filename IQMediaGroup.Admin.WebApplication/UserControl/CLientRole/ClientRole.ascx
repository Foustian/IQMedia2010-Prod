<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ClientRole.ascx.cs"
    Inherits="IQMediaGroup.Admin.Usercontrol.ClientRole.ClientRole" %>
                                        ...
                                        <td>
                                            <table border="0" cellspacing="5" cellpadding="0" >
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label>
                                                            <asp:DropDownList ID="ddlClient" runat="server" CssClass="dropdown01">
                                                            </asp:DropDownList>
                                                            <asp:RequiredFieldValidator ID="rfvClient" Text="*" ValidationGroup="validate" Display="Dynamic"
                                                                runat="server" InitialValue="0" ControlToValidate="ddlClient" ErrorMessage="Please Select Client."></asp:RequiredFieldValidator>
                                                        </label>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <%--<tr>
                                                    ...
                                                    <td class="bluebox-hd">
                                                        <asp:Label ID="lblClientRole" runat="server" Text="ClientRoles"></asp:Label><br />
                                                    </td>
                                                    <td width="3">
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" cellpadding="5" cellspacing="0" bordercolor="#e4e4e4" style="border: solid 1px #e4e4e4;
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="gvClientRole" runat="server" Width="100%" border="1" AllowPaging="True"
                                                            ...
                                                            PagerSettings-PreviousPageImageUrl="~/Images/arrow-previous.jpg" OnPageIndexChanging="gvClientRole_PageIndexChanging"
                                                            OnRowCancelingEdit="gvClientRole_RowCancelingEdit" OnRowEditing="gvClientRole_RowEditing"
                                                            OnRowUpdating="gvClientRole_RowUpdating" OnDataBound="gvClientRole_DataBound">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Client Name" HeaderStyle-HorizontalAlign="Left">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:HiddenField ID="hdnClientRoleKey" runat="server" Value='<%# Bind("ClientRoleKey") %>' />
                                                                    </ItemTemplate>
