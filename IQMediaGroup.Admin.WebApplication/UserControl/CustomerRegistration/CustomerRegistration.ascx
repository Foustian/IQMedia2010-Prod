                                                    ...
                                                    <asp:GridView ID="gvCustomer" runat="server" border="1" Width="100%" AllowPaging="True"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Customer Comment" HeaderStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCustomerComment" runat="server" Text='<%# Bind("Comment") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                                <ItemStyle CssClass="content-text"></ItemStyle>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ShowHeader="false" HeaderStyle-HorizontalAlign="Center">
                                                                <HeaderTemplate>
                                                                        <asp:Image ID="imgMultiLogin" runat="server" ImageUrl="~/Images/MultiLogin.jpg" />
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                        <asp:CheckBox ID="chkMultiLogin" Enabled="false" runat="server" Checked='<%# Eval("MultiLogin") %>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle CssClass="grid-th" VerticalAlign="Top" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ShowHeader="false" HeaderText="IQBasic" HeaderStyle-HorizontalAlign="Center">
                                                                <HeaderTemplate>
                                                                    <asp:Image ID="ingIQBasic" runat="server" ImageUrl="~/Images/IQBasic.jpg" />
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkIQBasic" Enabled="false" runat="server" Checked='<%# Eval("IQBasic") %>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle CssClass="grid-th" VerticalAlign="Top" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ShowHeader="false" HeaderStyle-HorizontalAlign="Center">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkAdvancedSearchAccess" Enabled="false" runat="server" Checked='<%# Eval("AdvancedSearchAccess") %>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle CssClass="grid-th" VerticalAlign="Top" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ShowHeader="false" HeaderStyle-HorizontalAlign="Center">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkGlobalAdminAccess" Enabled="false" runat="server" Checked='<%# Eval("GlobalAdminAccess") %>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            ...
                                                            <asp:TemplateField ShowHeader="false" HeaderStyle-HorizontalAlign="Center">
                                                                <HeaderTemplate>
                                                                    <asp:Image ID="ingIQBasic" runat="server" ImageUrl="~/Images/IQAgentUser.jpg" />
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkIQAgentUser" Enabled="false" runat="server" Checked='<%# Eval("IQAgentUser") %>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle VerticalAlign="Top" CssClass="grid-th" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ShowHeader="false" HeaderStyle-HorizontalAlign="Center">
                                                                <HeaderTemplate>
                                                                    <asp:Image ID="ingIQBasic" runat="server" ImageUrl="~/Images/IQAgentAdmin.jpg" />
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkIQAgentAdminAccess" Enabled="false" runat="server" Checked='<%# Eval("IQAgentAdminAccess") %>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle VerticalAlign="Top" CssClass="grid-th" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ShowHeader="false" HeaderStyle-HorizontalAlign="Center">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkmyIQAccess" runat="server" Enabled="false" Checked='<%# Eval("myIQAccess") %>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle VerticalAlign="Top" CssClass="grid-th" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ShowHeader="false" HeaderStyle-HorizontalAlign="Center">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkIQAgentWebsiteAccess" Enabled="false" runat="server" Checked='<%# Eval("IQAgentWebsiteAccess") %>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle VerticalAlign="Top" CssClass="grid-th" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ShowHeader="false" HeaderStyle-HorizontalAlign="Center">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkDownloadClips" runat="server" Enabled="false" Checked='<%# Eval("DownloadClips") %>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle VerticalAlign="Top" CssClass="grid-th" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ShowHeader="false" HeaderStyle-HorizontalAlign="Center">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkIQCustomAccess" runat="server" Enabled="false" Checked='<%# Eval("IQCustomAccess") %>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle VerticalAlign="Top" CssClass="grid-th" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ShowHeader="false" HeaderStyle-HorizontalAlign="Center">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkUGCDownload" runat="server" Enabled="false" Checked='<%# Eval("UGCDownload") %>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle VerticalAlign="Top" CssClass="grid-th" />
                                                            </asp:TemplateField>
